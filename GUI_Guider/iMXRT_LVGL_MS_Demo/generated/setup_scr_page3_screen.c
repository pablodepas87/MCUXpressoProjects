...
void setup_scr_page3_screen(lv_ui *ui){
	...
	lv_style_set_text_font(&style_page3_screen_cb_1_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_obj_set_pos(ui->page3_screen_ddlist_1, 163, 62);
	...
	lv_obj_set_style_local_text_font(ui->page3_screen_btn_1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &lv_font_simsun_12);
	...
	lv_obj_set_pos(ui->page3_screen_ddlist_2, 324, 63);
	...
	lv_style_set_text_font(&style_page3_screen_cb_2_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_page3_screen_cb_3_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_page3_screen_cb_4_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
