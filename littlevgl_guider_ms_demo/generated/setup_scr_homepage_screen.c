...
//	//Write style LV_CONT_PART_MAIN for homepage_screen_bkg_obj
	...
	lv_label_set_text(ui->homepage_screen_btn_5_label, "PG5");
	...
	lv_label_set_text(ui->homepage_screen_btn_6_label, "PG6");
	...
	lv_label_set_text(ui->homepage_screen_btn_7_label, "PG7");
	...
	lv_label_set_text(ui->homepage_screen_btn_8_label, "PG8");
	...
	lv_label_set_text(ui->homepage_screen_btn_9_label, "PG9");
